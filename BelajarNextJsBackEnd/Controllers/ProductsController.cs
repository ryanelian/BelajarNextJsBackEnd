...
using BelajarNextJsBackEnd.Models.Product;
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<ProductDataGridItem>>> GetProducts()
        {
          if (_context.Products == null)
          {
            ...
            return await _context.Products.AsNoTracking().Select(X=>new ProductDataGridItem
            {
                Id = X.Id,
                Name = X.Name,
        ...
        {
            var update = await _context.Products.Where(X => X.Id == id).FirstOrDefaultAsync();
            if (update == null)
            {
                return NotFound();
            }
